...
def calibrate(image_folder,output_file,squaresX = 6, squaresY = 10, squareLength = 0.025, markerLength =0.02, dictionary = 'DICT_4X4_250'):
    ...
    if len(image_filenames) == 0:
        ...
        camCal = {'camera_matrix':cameraMatrix.tolist(),'distortion_coefficients': distCoeffs.squeeze().tolist()}
...
if __name__ == "__main__":  
    ...
    parser.add_argument("--camCalJson",nargs="?",default='./json/charucoBoard.json',help="charuco json file")
    parser.add_argument("--output_file",nargs="?",default='./json/camCal.json',help="output file")
